...
import { FamilyCareRoadmapForm } from "@/components/families/FamilyCareRoadmapForm";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export const metadata: Metadata = familiesMetadata;

const familyScheduleHref = getDpcQuizScheduleLink("family");
const familyPlan = MEMBERSHIP_PLANS.find((plan) => plan.id === "family");
const supportPlanPreview = MEMBERSHIP_PLANS.filter((plan) => plan.id !== "family");
const medicalDirector = getMedicalDirector();
const familyProviders = [medicalDirector, ...getLeadPAs().slice(0, 2)].filter(
  (provider): provider is NonNullable<typeof provider> => Boolean(provider)
);

const familySupportHighlights = [
  ...
  "One local care team can help guide next steps when routine health questions come up.",
] as const;

const familyMembershipSteps = [
  {
    title: "Start with your household questions",
    body: "We begin with who needs care, what usually creates friction, and how your family wants care to feel when something comes up.",
  },
  {
    title: "Confirm who fits the family route",
    body: "The current governed family plan is written for families with dependent children ages 12 and older. Call or text to confirm how your household would be structured.",
  },
  {
    title: "Use the clinic as your practical first stop",
    body: "For everyday primary care questions, your household can start with DirectCare Indy instead of defaulting to fragmented phone trees and urgent care detours.",
  },
] as const;

const includedFamilyItems = [
...
const familyFaq = [
  {
    question: "Can parents and children use DirectCare Indy?",
    answer:
      "DirectCare Indy offers a governed family membership path for households exploring primary care access together. The current pricing source describes the family plan for dependent children ages 12 and older, so call or text the clinic to confirm how your household would fit.",
  },
  {
    question: "What ages are eligible for family membership?",
    answer:
      "The active membership source describes the family route as being for families with dependent children ages 12 and above. If your household has a different mix of needs or ages, the clinic can talk through the most practical next step.",
  },
  {
    question: "What should we do when someone gets sick?",
    answer:
      "For non-emergency needs, call or text the clinic so the team can help guide the next step. Same-day or next-day visits may be available when appropriate, and telehealth may be available when appropriate. For emergencies, call 911.",
  },
  {
  ...
  {
    question: "Can we use DirectCare Indy with a high-deductible plan?",
    answer:
      "Many households explore Direct Primary Care alongside a high-deductible plan because they want a more usable first stop for everyday care. The clinic can help you understand whether that setup may fit your family, but it is not a replacement for major medical coverage.",
  },
  {
    question: "How do we confirm family pricing?",
    answer:
      "Use the pricing preview below as the governed starting point, then call or text DirectCare Indy to confirm current family pricing. Pricing and availability are subject to change.",
  },
  {
    question: "What happens if we need a specialist or emergency care?",
    answer:
  ...
  return (
    <main className="min-h-screen bg-background">
      <section className="relative overflow-hidden bg-primary pb-18 pt-24 text-primary-foreground lg:pb-24 lg:pt-30">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Direct Care Indy helping a family plan their next care step"
            fill
        ...
        <div className="content-container relative z-10">
          <div className="mx-auto max-w-5xl text-center">
            ...
            <h1 className="heading-1-inverse mt-6 text-glow sm:text-5xl lg:text-6xl">
              Family care without the scramble
            </h1>
            <p className="body-large-inverse mx-auto mt-5 max-w-3xl font-medium text-white/90">
              When someone in your house gets sick, you need a care path you can actually use.
              DirectCare Indy helps families get clearer next steps, local primary care access, and
              transparent membership options.
            </p>

            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Link
                href="#family-care-roadmap"
            ...
            <ul className="mt-10 flex flex-wrap items-center justify-center gap-3 text-sm">
              {[
                ...
                "Family membership preview",
                "Non-emergency sick-day guidance",
              ].map((item) => (
                <li
                  key={item}
          ...
          <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="section-card border-secondary/10 bg-linear-to-br from-secondary/5 via-card to-card">
              ...
              <h2 className="mt-3 text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
                Fever at night. School tomorrow. You want a care path, not a phone tree.
              </h2>
              <div className="mt-5 space-y-4 text-base leading-relaxed text-muted-foreground">
                <p>
                  Families do not need more healthcare friction. They need practical guidance when
                  something changes at 8 p.m., when a cough starts on Sunday, or when the question
                  is not &ldquo;Who is in network?&rdquo; but &ldquo;What should we do next?&rdquo;
                </p>
                <p>
                  DirectCare Indy is built to make those everyday moments easier to navigate. For
                  non-emergency needs, members can call or text the clinic, ask what makes sense,
                  and work from a clearer local care path.
                </p>
              </div>
            </div>
            ...
            <div className="section-card">
              ...
              <ul className="mt-5 space-y-3">
                {familySupportHighlights.map((item) => (
      ...
      <section className="section-padding-sm bg-muted/35">
        <div className="content-container">
          <SectionHeading
            eyebrow="How family membership works"
            title="A simpler first stop for the everyday healthcare questions households actually have"
          >
            <p>
              This page is for families who want to understand what membership means in real life:
              who it may fit, what the clinic can help with, and how to get a practical next step
              before healthcare turns into a scramble.
            </p>
          </SectionHeading>

          <ol className="mx-auto mt-12 grid max-w-6xl gap-5 md:grid-cols-3">
            {familyMembershipSteps.map((step, index) => (
      ...
      <section className="section-padding-sm">
        <div className="content-container">
          <SectionHeading
            ...
            title="What family membership is designed to include and where other care still matters"
          >
            <p>
              Direct Primary Care works best when families understand the boundary lines. It can be
              a useful everyday care relationship, but it is not the same thing as insurance.
            </p>
          </SectionHeading>
          ...
          <div className="mx-auto mt-12 grid max-w-6xl gap-6 lg:grid-cols-2">
            ...
            <article className="section-card border-border/80">
              ...
              <ul className="mt-5 space-y-3">
                {notIncludedFamilyItems.map((item) => (
                  <li key={item} className="flex items-start gap-3 text-sm text-muted-foreground">
        ...
        <div className="content-container">
          ...
          >
            <p>
              ...
              starting point, then call or text DirectCare Indy to confirm current family pricing
              for your household.
            </p>
          </SectionHeading>
            ...
            {familyPlan ? (
              <article className="section-card flex flex-col border-secondary/30 ring-2 ring-secondary/15">
                ...
                <ul className="mt-5 space-y-2">
                  {familyPlan.benefits.slice(0, 4).map((benefit) => (
                    <li
                      key={benefit}
          ...
          <div className="mx-auto mt-8 max-w-5xl rounded-[2rem] border border-border bg-white px-6 py-6 shadow-sm">
            <p className="text-sm leading-relaxed text-muted-foreground">
              Pricing is subject to change. Call or text DirectCare Indy to confirm current family
              pricing. Direct Primary Care is not insurance and does not replace major medical
              coverage.
            </p>
          </div>
        </div>
          ...
          <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[0.95fr_1.05fr]">
            <article className="section-card border-primary/10 bg-linear-to-br from-primary/5 via-card to-card">
              ...
              <p className="mt-4 text-base leading-relaxed text-muted-foreground">
                DirectCare Indy serves families who want a more practical care relationship close
                to home, including households in Indianapolis, Carmel, Zionsville, Fishers, Geist,
      ...
      <section className="section-padding-sm bg-muted/35">
        <div className="content-container">
          ...
          >
            <p>
              Families often want to know who will be guiding the next step. The provider details
              below come from the live provider directory and link to full bios.
            </p>
          </SectionHeading>
      ...
      <section className="section-padding-sm">
        <div className="content-container max-w-5xl">
          <FamilyCareRoadmapForm />
        </div>
      </section>

      <section className="section-padding-sm bg-muted/40">
        <div className="content-container">
          <SectionHeading eyebrow="FAQ" title="Family membership questions we can answer carefully">
            <p>
              These answers stay inside the current site guardrails and active pricing source.
              When a household question gets more specific, call or text the clinic for the current
              answer.
            </p>
          </SectionHeading>
          ...
          <div className="mx-auto mt-12 max-w-4xl overflow-hidden rounded-[2rem] border border-border bg-card px-6 shadow-sm md:px-8">
            <Accordion type="single" collapsible>
              {familyFaq.map((item, index) => (
                <AccordionItem key={item.question} value={`family-faq-${index}`}>
                  <AccordionTrigger itemValue={`family-faq-${index}`}>
                    {item.question}
                  </AccordionTrigger>
                  <AccordionContent itemValue={`family-faq-${index}`}>
      ...
      <section className="section-padding bg-primary text-primary-foreground">
        <div className="content-container-narrow text-center">
          <h2 className="heading-2-inverse mb-4">Still trying to make family care feel simpler?</h2>
          <p className="body-large-inverse mx-auto max-w-2xl">
            Start with the Family Care Roadmap, talk with the local team, or use the 60-second
            guide if you are still comparing care paths.
          </p>
